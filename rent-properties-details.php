...
try {
    $pdo = hh_db();
    $stmt = $pdo->prepare('SELECT * FROM rent_properties_list WHERE id = :id LIMIT 1');
...
$primaryImage = $heroBanner ?? ($galleryImages[0] ?? 'assets/images/banner/rent-properties-banner.webp');
                ...
                <?php if ($startingPriceValue !== ''): ?>
                    <div class="col-6 col-md-2">
                        <div class="info-card p-4 text-center h-100 text-white">
                            <img src="assets/icons/dollar.png" alt="Rent" width="28" class="mb-2">
                            <div class="details">
                                Rent From -
                    ...
                    <div class="hh-gallery-01-wrap " data-animation-in="animate__fadeInLeft"
                        ...
                        <div class="swiper hh-gallery-01-main">
                            <div class="swiper-wrapper">
                                ...
                                <?php else: ?>
                                    <div class="swiper-slide">
                                        <img src="assets/images/banner/rent-properties-banner.webp" alt="Placeholder image">
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="swiper hh-gallery-01-thumbs">
                            <div class="swiper-wrapper">
                                <?php if ($galleryImages): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <div class="swiper-slide"><img src="assets/images/banner/rent-properties-banner.webp" alt="">
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
